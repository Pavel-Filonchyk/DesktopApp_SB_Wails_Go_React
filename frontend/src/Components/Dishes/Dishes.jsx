...
export default function Dishes() {
  ...
  const postDishes = useSelector(({restMenuReducer: { postDishes }}) => postDishes)
  ...
  return (
    <div className={style.wrapDishes}>
      ...
      <span className={style.mainTitle}>{postDishes[nameDish]}</span>
      <div className={style.blockDishes}>
        {
         _.map(postDishes.dishes, (item, index) => {return(
